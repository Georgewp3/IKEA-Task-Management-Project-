...
export default function UserTab() {
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <h1 className="text-3xl font-bold text-center mb-8">User Entries</h1>
      
      <div className="entry-grid grid grid-cols-3 gap-4 items-center mb-8 bg-white p-6 rounded-lg shadow-sm border">
        {/* STEP 1 */}
        <div className="step-label text-sm font-semibold text-gray-600">STEP 1</div>
        <div className="step-action text-sm font-medium">SELECT USER →</div>
        ...
        {/* PROJECT display */}
        <div className="project-label text-sm font-semibold text-gray-600">PROJECT</div>
        <div className="project-name text-sm font-medium col-span-2" data-testid="text-user-project">
          {selectedUserData?.project || "---"}
        </div>

        {/* STEP 2 */}
        <div className="step-label text-sm font-semibold text-gray-600">STEP 2</div>
        <div className="step-action text-sm font-medium">SELECT TASK →</div>
        <div className="step-input">
        ...
        {/* STEP 3 */}
        <div className="step-label text-sm font-semibold text-gray-600">STEP 3</div>
        <div className="step-action text-sm font-medium">TASK STATUS →</div>
        <div className="step-input">
        ...
        {/* STEP 4 */}
        <div className="step-label text-sm font-semibold text-gray-600">STEP 4</div>
        <div className="step-action text-sm font-medium">OPTIONAL COMMENT →</div>
        <div className="step-input">
          <Textarea
            placeholder=""
            value={comment}
